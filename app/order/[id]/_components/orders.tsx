    ...
    <div className="px-4 py-8 mx-auto md:px-6 lg:px-8">
      ...
      <div className="overflow-x-auto">
        <Table>
          ...
          <TableBody>
            {error || orders.length === 0 || orders === null ? (<div className="flex items-center justify-center py-20">
            ...
            <TableRow key={order.id}>
              ...
              <TableCell>{order.created_at ? format(order.created_at?.toString(), "PPP") : null}</TableCell>
              <TableCell>{order.order_amount ? formatCurrency(order?.order_amount) : null}</TableCell>
              <TableCell>
