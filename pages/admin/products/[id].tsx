...
const UpdateProduct = ({ product, categories }: { product: Product, categories: Category[]}) => {
        ...
        .update([
          {
            ...
            category: selected.id || product.category.id,
          },
        ]).eq('id', product.id);
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          >
            ...
            {productImage === "" ? (
              ...
              <img className="w-1/3 mt-4 object-cover" src={product.image} />
            )}
